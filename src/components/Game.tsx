...
export const Game: React.FC<IProps> = ({ library, account }) => {
  ...
  return (
    <>
      <div
        className=" md:grid  mt-20   md:grid-cols-3 md:-mt-12 justify-center items-center max-w-4xl mx-auto "
        id="page"
      >
        <div className=" lg:col-start-1 pt-5 md:mt-0 items-center flex flex-col max-w-4xl mx-auto ">
          {isGameActive ? (
        ...
        <div className=" md:col-start-2 flex flex-col justify-center items-center max-w-4xl mx-auto">
        <Image
                className=" "
                src={"/dealer.svg"}
                width={350}
