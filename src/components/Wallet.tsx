...
export const Wallet: React.FC<IProps> = ({
  ...
  return (
    <div>
      {account ? (
        <button
          className="focus:outline-none font-roboto  text-white font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 bg-[#e57310] hover:bg-[#d16413] focus:ring-blue-800"
          onClick={disconnect}
        >
